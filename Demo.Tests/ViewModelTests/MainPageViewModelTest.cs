using System;
using Demo.Tests.ViewModelTests.Base;

namespace Demo.Tests.ViewModelTests
{
	public class MainPageViewModelTest : BaseViewModelTest
	{
        #region Fields
        ...
        public MainPageViewModelTest() : base()
        {
